...
- (id)initWithFrame:(CGRect)frame WithTitle: (NSString *) title Section:(NSInteger)sectionNumber delegate: (id <SectionView>) Delegate
{
    ...
    if (self) { 
        ...
        CGRect LabelFrame =  CGRectMake(50, self.bounds.origin.y, self.bounds.size.width, self.bounds.size.height);
        LabelFrame.size.width -= 50;
        CGRectInset(LabelFrame, 5.0, 5.0);
        ...
        if (colors == nil) {
            ...
            UIColor *color = nil;
            color = [UIColor colorWithRed:0.15 green:0.14 blue:0.15 alpha:1];
